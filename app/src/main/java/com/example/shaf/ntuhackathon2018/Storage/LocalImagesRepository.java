...
/**
 * Repository of images that stores data on the device.
 */
public class LocalImagesRepository implements ImagesRepository {
     ...
     * An {@link com.example.shaf.ntuhackathon2018.Image} contains a {@link Bitmap} and a string with its filename.
     *
     * @return
     */
    @Override
